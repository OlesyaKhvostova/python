...
def create_save_dict(user_file_name, hobby_file_name, user_hobby_file_name):
    result = 0
    user_file = open(user_file_name, 'r', encoding='utf-8')
    hobby_file = open(hobby_file_name, 'r', encoding='utf-8')
    user_hobby_file = open(user_hobby_file_name, 'w', encoding='utf-8')
...
def main(argv):
    ...
    init_files(args[0], args[1])
    return create_save_dict(args[0], args[1], args[2])
